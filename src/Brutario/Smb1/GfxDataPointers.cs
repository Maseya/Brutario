namespace Brutario.Smb1
{
    ...
    {
        public static readonly GfxDataPointers Jp10 = new GfxDataPointers(
            baseAddress: 0x05E6BA);

        public static readonly GfxDataPointers Jp11 = new GfxDataPointers(
            baseAddress: 0x05E70B);

        public static readonly GfxDataPointers Usa = new GfxDataPointers(
            baseAddress: 0x05E6C3);

        public static readonly GfxDataPointers UsaPlusW = new GfxDataPointers(
            baseAddress: 0x05E714);

        public static readonly GfxDataPointers Eu = new GfxDataPointers(
            baseAddress: 0x05E714);

        public static readonly GfxDataPointers EuPlusW = new GfxDataPointers(
            baseAddress: 0x05E714);

        public static readonly GfxDataPointers UsaSmb1 = new GfxDataPointers(
